...
import internvl_mmhal_native_loop as mm


RELEASE_ROOT = Path(__file__).resolve().parents[1]
ROOT = Path(os.environ.get("ALC_OUTPUT_DIR", RELEASE_ROOT / "outputs"))
JSONL_PATH = Path(os.environ.get("ALC_COCO_JSONL", "<PATH_TO_COCO_500_JSONL>"))
IMAGE_FOLDER = Path(os.environ.get("ALC_COCO_IMAGE_DIR", "<PATH_TO_COCO>/val2014"))
