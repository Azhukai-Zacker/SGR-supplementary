...
COCO-CHAIR results are reported from the saved JSON files under `results/chair/`. MMHal-Bench and LLaVA-Bench results are reported from the saved response and judge summary files under `results/mmhal/` and `results/llava_bench/`.
